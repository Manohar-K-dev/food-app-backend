...
//   try {
//     apiLogger.info("Fetching user cart", { userId: user._id, currentServer });
...
//       apiLogger.info("Empty cart created", { userId: user._id, currentServer });
...
//     apiLogger.info("Cart fetched successfully", {
//       userId: user._id,
...
//     });
//   } catch (error) {
//     apiLogger.error("Failed to fetch cart", {
//       error: error.message,
//       userId: user._id,
//       currentServer,
//     });
...
//   try {
//     apiLogger.info("Adding item to cart", {
//       userId: user._id,
//       productId,
//       quantity,
//       currentServer,
...
//     if (!product) {
//       apiLogger.warn("Product not found for cart", {
//         productId,
//         currentServer,
//       });
...
//       apiLogger.warn("Product not available", { productId, currentServer });
//       return res.status(400).json({
//         success: false,
...
//     apiLogger.info("Item added to cart", {
//       userId: user._id,
//       productId,
//       quantity,
//       currentServer,
...
//     });
//   } catch (error) {
//     apiLogger.error("Failed to add item to cart", {
//       error: error.message,
//       userId: user._id,
//       currentServer,
//     });
...
//   try {
//     apiLogger.info("Updating cart item", {
//       userId: user._id,
//       productId,
//       quantity,
//       currentServer,
...
//     if (!cart) {
//       apiLogger.warn("Cart not found for update", {
//         userId: user._id,
//         currentServer,
//       });
//       return res.status(404).json({
...
//     if (itemIndex === -1) {
//       apiLogger.warn("Item not found in cart", {
//         userId: user._id,
//         productId,
//         currentServer,
//       });
...
//     apiLogger.info("Cart item updated", {
//       userId: user._id,
//       productId,
...
//     });
//   } catch (error) {
//     apiLogger.error("Failed to update cart item", {
//       error: error.message,
//       userId: user._id,
//       currentServer,
//     });
...
//   try {
//     apiLogger.info("Removing item from cart", {
//       userId: user._id,
//       productId,
//       currentServer,
//     });
...
//     if (!cart) {
//       apiLogger.warn("Cart not found for removal", {
//         userId: user._id,
//         currentServer,
//       });
//       return res.status(404).json({
...
//     });
//   } catch (error) {
//     apiLogger.error("Failed to remove item from cart", {
//       error: error.message,
//       userId: user._id,
//       currentServer,
//     });
...
//   try {
//     apiLogger.info("Clearing cart", { userId: user._id, currentServer });

//     const cart = await Cart.findOne({ user: user._id });

//     if (!cart) {
//       apiLogger.warn("Cart not found for clearing", {
//         userId: user._id,
//         currentServer,
//       });
//       return res.status(404).json({
...
//     apiLogger.info("Cart cleared", { userId: user._id, currentServer });
...
//     });
//   } catch (error) {
//     apiLogger.error("Failed to clear cart", {
//       error: error.message,
//       userId: user._id,
//       currentServer,
//     });
...
// // Sync Cart (from other server) - REGULAR ROUTE HANDLER
...
// // Sync Cart Update (from other server) - REGULAR ROUTE HANDLER
...
// // Sync Cart Clear (from other server) - REGULAR ROUTE HANDLER
...
//     apiLogger.info("Cart cleared via sync", { syncId, currentServer });
